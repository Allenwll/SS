...
(function ($) {
    ...
    $.fn.tabs.parseOptions = function (_398) {
        return $.extend({}, $.parser.parseOptions(_398, ["tools", "toolPosition", "tabPosition", {fit: "boolean", border: "boolean", plain: "boolean"}, {
            headerWidth: "number",
            tabWidth: "number",
            tabHeight: "number",
            selected: "number"
    ...
    function _3ca(_3cb, _3cc, _3cd) {
        ...
        function _3d3() {
            ...
            if (_3cc == "east") {
                ...
                return {
                    resizeC: {width: _3da},
                    expand: {left: cc.width() - _3d9},
                    expandP: {top: _3d7.top, left: cc.width() - _3d8, width: _3d8, height: _3d7.height},
                    collapse: {left: cc.width(), top: _3d7.top, height: _3d7.height}
                };
            } else {
                if (_3cc == "west") {
                    var _3d9 = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3da, left: _3d8 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3d7.top, width: _3d8, height: _3d7.height},
                        collapse: {left: -_3d9, top: _3d7.top, height: _3d7.height}
                    };
                } else {
                    if (_3cc == "north") {
                        ...
                        return {
                            resizeC: {top: _3d8 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3d8},
                            collapse: {top: -_3db, width: cc.width()}
                        };
                    } else {
                        if (_3cc == "south") {
                            var _3db = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3db},
                                expandP: {top: cc.height() - _3d8, left: 0, width: cc.width(), height: _3d8},
...
(function ($) {
    ...
    function _40c(_40f, div, _410) {
        var item = $(div);
        var _411 = $.extend({}, $.parser.parseOptions(item[0], ["id", "name", "iconCls", "href", {separator: "boolean"}]), {
    ...
    $.fn.menu.parseOptions = function (_458) {
        return $.extend({}, $.parser.parseOptions(_458, [{minWidth: "number", itemHeight: "number", duration: "number", hideOnUnhover: "boolean"}, {
            fit: "boolean",
            inline: "boolean",
            noline: "boolean"
        }]));
    ...
    $.fn.menu.defaults = {
        ...
        fit: false,
        noline: false,
        events: {mouseenter: _41d, mouseleave: _420, mouseover: _424, mouseout: _427, click: _429},
...
(function ($) {
    ...
    $.fn.switchbutton.parseOptions = function (_4a1) {
        var t = $(_4a1);
        return $.extend({}, $.parser.parseOptions(_4a1, ["onText", "offText", "handleText", {handleWidth: "number", reversed: "boolean"}]), {
...
(function ($) {
            ...
            if (col && col.editor) {
                ...
                if (_774) {
                    ...
                    $.data(cell[0], "datagrid.editor", {
                        actions: _774,
                        target: _774.init(cell.find("td"), $.extend({height: opts.editorHeight}, _773)),
                        field: _771,
                        type: _772,
                        oldHtml: _775
                    });
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        rownumberWidth: 30,
        editorHeight: 24,
        headerEvents: {mouseover: _697(true), mouseout: _697(false), click: _69b, dblclick: _6a0, contextmenu: _6a3},
        rowEvents: {mouseover: _6a5(true), mouseout: _6a5(false), click: _6ac, dblclick: _6b6, contextmenu: _6ba},
...
(function ($) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        singleSelect: true,
        view: _97e,
        rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, {mouseover: _8f6(true), mouseout: _8f6(false), click: _8f8}),
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _9fe, keydown: _a02, paste: _a02, drop: _a02},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
