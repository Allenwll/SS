...
//			console.info('_startMove');
		
			var move, moveEvent, moveStartEvent,endEvent,
			...
			// Use proper events
			if (pointerEvents) {
//				moveStartEvent='pointerdown';
				moveEvent = 'pointermove';
				endEvent = 'pointerup';
			} else if (event.type === 'touchstart') {
//				moveStartEvent='touchstart';
				moveEvent = 'touchmove';
				endEvent = 'touchend';
			} else {
//				moveStartEvent="mousedown";
				moveEvent = 'mousemove';
				endEvent = 'mouseup';
			}
...
//					},100);
	...
	$.fn.panzoom = function(options) {
		...
		return this.each(function() {
					this.Panzoom=new Panzoom(this, options);
				});
	};
